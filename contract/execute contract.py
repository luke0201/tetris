...
#todo: change account and password according to mote ip
...
contract_address = "0xB4A2666fed0f5d51A1CCd4fe07DFa37C2d268292"

# Get contract object at contract_address
contract_instance = w3.eth.contract(contract_address, abi=contract_interface['abi'])

# Participating in game
# todo: change 'from' account according to mote ip
contract_instance.functions.participatingInGame(1).transact({'from': w3.eth.accounts[0], 'to': contract_address, 'value': w3.toWei(10, 'ether')})
print('function with transaction from server')
